...
# println("overwritten Pkg.Types.write_env_usage")
# flush(stdout)
...
# NSR = 0.5, and DAR set to do the intergral normalisation
noise_stimulus_ratio=0.1 
# noise_stimulus_ratio=0.05 
...
ITPCrange=(5.5,10.0)
#F from array index.
Fidx=parse(Int32,ARGS[1]) 
Fs=collect(2:0.5:10.0)
F=Fs[Fidx]
...
t=time()
run_coupled_oscillator_modulated_noise_tests_serial_varydriveamplituderatio_60trials_randinitcond("FreqVary_freq$(F)Hz_SNR05_high_c_60randinitcond_seeded_noise_normalised_nonrectified_modulated_phasemod_$(phase_modulation)_integralnormalised_coupled_oscillator_control_test_$(noise_ref)",[drive_amplitude_ratio],sorting_indices,peak_deriviative_data,p,u0,time_range,ITPCrange,noise_stimulus_ratio,phoneme_sequence_envelopes,save_path,noisesets,save_traj)
