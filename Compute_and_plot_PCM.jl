...
frequencies=collect(range(0.5,30.0,length=60)) #60 frequencies between 2 and 15 Hz
sine_path1="/Users/as15635/Documents/Projects/Shannon_et_al/Sine_Drives/5000.0sr_wide_drive_interpolators_1.jld2"
sine_path2="/Users/as15635/Documents/Projects/Shannon_et_al/Sine_Drives/5000.0sr_wide_drive_interpolators_2.jld2"
sine_path3="/Users/as15635/Documents/Projects/Shannon_et_al/Sine_Drives/5000.0sr_wide_drive_interpolators_3.jld2"
...
scatter(Evoked_PCMs,xlims=(-1,1),ylims=(-1,1),aspect_ratio=:equal,title="sine wave stim - evoked model",marker_z=frequencies)
...
F=4.0
# phoneme_sampling_rate=44100
phoneme_sampling_rate=5000.0
drive_amplitude=40000.0
...
frequencies=range(0.5,30,length=60)
...
scatter(tuned_phase_resetting_oscillator_PCMs,xlims=(-1,1),ylims=(-1,1),aspect_ratio=:equal,title="$(phoneme_sampling_rate)sr_ 40000 impulse stim - coupled oscillator",marker_z=frequencies)
...
scatter(slow_NMM_PCMs,xlims=(-1,1),ylims=(-1,1),aspect_ratio=:equal,title="sine wave stim - 4Hz NGNMM",marker_z=frequencies)
...
scatter(fast_NMM_PCMs,xlims=(-1,1),ylims=(-1,1),aspect_ratio=:equal,title="sine wave stim - 19Hz NGNMM",marker_z=frequencies)
...
p1=scatter(Evoked_PCMs,xlims=(-1,1),ylims=(-1,1),aspect_ratio=:equal,marker_z=frequencies,label=nothing, cbar=false);
plot!(p1, circle_x, circle_y, linestyle=:dash, linecolor=:gray, label=nothing);
...
p2=scatter(tuned_phase_resetting_oscillator_PCMs,xlims=(-1,1),ylims=(-1,1),aspect_ratio=:equal,marker_z=frequencies,label=nothing, cbar=false);
plot!(p2, circle_x, circle_y, linestyle=:dash, linecolor=:gray, label=nothing);
...
p3=scatter(slow_NMM_PCMs,xlims=(-1,1),ylims=(-1,1),aspect_ratio=:equal,marker_z=frequencies,label=nothing, cbar=false);
plot!(p3, circle_x, circle_y, linestyle=:dash, linecolor=:gray, label=nothing);
...
p4=scatter(fast_NMM_PCMs,xlims=(-1,1),ylims=(-1,1),aspect_ratio=:equal,marker_z=frequencies,label=nothing,cbar=false);
plot!(p4, circle_x, circle_y, linestyle=:dash, linecolor=:gray, label=nothing);
...
plot(p1,p2,p3,p4,h2,layout=l,size=(1100,800))
